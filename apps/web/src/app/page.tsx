      ...
      <header className="relative z-10 border-b border-[#C8A96A]/10 bg-[#0D0D0D]/40 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full overflow-hidden flex items-center justify-center bg-[#000] shadow-[0_0_20px_rgba(200,169,106,0.25)] border border-[#C8A96A]/20">
